    ...
    render() {
        return (
            <div class="container">
                ...
                <h1 class="my-4 " align="center">Recuerda esto antes de adoptar una mascota</h1>

                <div class="row">
                    <div class="mx-auto d-block ">
                        <img class="img-fluid" src="https://images.unsplash.com/photo-1504803542671-cb92eb06a148?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                    </div>

                    <div class="col-md-20">
                        <h3 class="my-3">¿Qué es la adopción responsable?</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 mb-4">
                                <img class="img-fluid" src="https://images.unsplash.com/photo-1521354465180-c1ceac1d709a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                            </div>

                            <div class="col-md-3 col-sm-6 mb-4">
                                <img class="img-fluid" src="https://images.unsplash.com/photo-1470390356535-d19bbf47bacb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                            </div>

                            <div class="col-md-3 col-sm-6 mb-4">
                                <img class="img-fluid" src="https://images.unsplash.com/photo-1496284427489-f59461d8a8e6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                            </div>

                            <div class="col-md-3 col-sm-6 mb-4">
                                <img class="img-fluid" src="https://images.unsplash.com/photo-1424709746721-b8fd0ff52499?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                            </div>

                        </div>

                        <div class="col-md-20">
                            <h3 class="my-3">Los beneficios de adoptar una mascota</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 mb-4">
                            <img class="img-fluid" src="https://images.unsplash.com/photo-1463008420065-8274332e2be8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                        </div>

                        <div class="col-md-3 col-sm-6 mb-4">

                            <img class="img-fluid" src="https://images.unsplash.com/photo-1429963845899-06ea8dc67d0d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                        </div>

                        <div class="col-md-3 col-sm-6 mb-4">

                            <img class="img-fluid" src="https://images.unsplash.com/photo-1542765826-d17aa264390d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />
                        </div>
